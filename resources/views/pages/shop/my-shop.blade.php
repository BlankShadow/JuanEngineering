      ...
      <div class="content-body-x ">
        <div class="container min-x">
            <div class="row indention-x shop-header">
	            <div class="col-md-5">
	            	<h3 class="shopheader">My Shop</h3>
	            </div>
	            ...
	            <div class="col-md-1 inputtype">
	            	<button class="btn-md-x text-grey pull-right" data-toggle="modal" data-target="#shop-submit"> Sell Art </button>
	            </div>
	        </div>
						...
						<div class="thumbnail">
							...
							<div class="caption">
								<div class="entry-artist">
									<span>by:
										<i><a class="" href="profile">Cookie</a></i>
									</span>
								</div>
							</div>
						</div>
          ...
          @include('includes.shop-submit-designmodal')
