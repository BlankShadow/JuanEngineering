              ...
              <div class="row indention-x options">
                  <div class="col-md-3">
                    <select>
                      ...
                      <option selected="yes">Finished</option>
                    </select>
                  </div>
                  <div class="col-md-5">
                    <ul class="nav nav-pills">
                      <li lcass="nav-item">
                        <a class="btn-md-x straight-header-nav-x " id="activeTab" href="#tab1" role="tab" data-toggle="tab">All Finished</a>
                      </li>
                      <li class="nav-item">
                        <a class="btn-md-x straight-header-nav-x" href="#tab2" role="tab" data-toggle="tab">Watched</a>
                      </li>
                      <li class="nav-item">
                        <a class="btn-md-x straight-header-nav-x" href="#tab3" role="tab" data-toggle="tab">Entered</a>
                      </li>
                      <li class="nav-item">
                        <a class="btn-md-x straight-header-nav-x" href="#tab4" role="tab" data-toggle="tab">Won</a>
                      </li>
                    </ul>
                  </div>
                  <div class="col-md-4">
                ...
                <div role="tabpanel" class="tab-pane active" id="tab1">
                    <div class="row indention-x">
                      ...
                      <div class="col-md-8 ">
                        ...
                        <div class="col-md-12 indention-x">
                          <span class="tagBtn">Watched</span>
                  ...
                  <div class="row indention-x">
                      ...
                      <div class="col-md-8 ">
                        ...
                        <div class="col-md-12 indention-x">
                          <span class="tagBtn">Entered</span>
